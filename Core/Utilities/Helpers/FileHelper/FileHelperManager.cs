...
{
    //Projeme yükleyeceğim dosyalarla ilgili upload, delete, update işlemlerini bu class'ta yapıyoruz.
    public class FileHelperManager : IFileHelper
    {
        ...
        public string Upload(IFormFile file, string root)
        {
            if (file.Length > 0) //dosya gönderildi mi gönderilmedi mi?
            {
                ...
                string guid = GuidHelperr.CreateGuid(); //GuidHelper klasörünü incele
